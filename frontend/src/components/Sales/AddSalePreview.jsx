					...
					<Grid container spacing={2} mt={1} mb={2}>
						...
						<Grid item md={3}>
							<TextField
								...
								value={props.sellingChannel.name}
								fullWidth
								variant="standard"
								sx={{
									'& .MuiInput-underline:before': {
						...
						{props.salePerformDate && (
							<Grid item md={3}>
								<TextField
									label="Fecha de Venta"
									value={props.salePerformDate}
									fullWidth
									variant="standard"
									sx={{
										'& .MuiInput-underline:before': {
