...
function AddSellingChannelModal(props) {
	...
	useEffect(() => {
		setDescriptionText(
			props.editSellingChannel.length !== 0 ? 'editado' : 'agregado'
		);
		setMessageText(
			props.editSellingChannel.length !== 0
				? 'Todos los cambios fueron registrados.'
				: ' El Canal de Ventas fue agregado exitosamente.'
		);
	}, [props]);
	return (
		<Dialog onClose={handleClose} open={open} fullScreen={fullScreen}>
			...
			<DialogTitle style={{ textAlign: 'center' }}>
				Canal de Ventas {descriptionText} exitosamente.
			</DialogTitle>
			<DialogContent>
				<DialogContentText
...
export default AddSellingChannelModal;
