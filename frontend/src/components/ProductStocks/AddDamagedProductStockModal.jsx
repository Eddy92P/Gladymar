...
function AddDamagedProductStockModal(props) {
	...
	useEffect(() => {
		setDescriptionText('agregado');
		setMessageText(' Se agregaron productos dañados exitosamente.');
	}, [props]);
	return (
		<Dialog onClose={handleClose} open={open} fullScreen={fullScreen}>
			...
			<DialogTitle style={{ textAlign: 'center' }}>
				Producto dañado {descriptionText} exitosamente.
			</DialogTitle>
			<DialogContent>
				<DialogContentText
...
export default AddDamagedProductStockModal;
