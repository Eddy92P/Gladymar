...
class PublicProductStockApiTests(TestCase):
    ...
    def test_auth_required(self):
        ...
        url = reverse(
            'sale:productstock-increment-damaged-stock',
            args=[
                product_stock.id])
...
class PrivateProductStockApiTests(TestCase):
    ...
    def test_increment_damaged_stock_success(self):
        ...
        self.assertIn(
            'Stock dañado incrementado en 10 unidades',
            res.data['message'])
    ...
    def test_increment_damaged_stock_exceeds_available(self):
        """Test incrementing damaged stock beyond available fails."""
        product_stock = create_product_stock(
            stock=100,
            reserved_stock=20,
            available_stock=80,
        ...
        self.assertIn(
            'no puede ser mayor al stock disponible', str(
                res.data['quantity']))
    ...
    def test_increment_damaged_stock_exactly_available(self):
        """Test incrementing damaged stock with exact available amount."""
        product_stock = create_product_stock(
            stock=100,
            reserved_stock=20,
            available_stock=80,
    ...
    def test_increment_damaged_stock_with_existing_damaged_stock(self):
        """Test incrementing damaged stock when some damaged stock exists."""
        product_stock = create_product_stock(
            stock=100,
            reserved_stock=20,
            available_stock=60,
